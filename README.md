...
- ルート: `/Users/tsuyoshiyamada/ai-workbench/work/abil-weekly-automation/`
- **レポートのビジュアル完成形・仕組み図解のHTML**: [reference/](./reference/README.md)

**関連ワークスペース（ブランド・資料）**

- `/Users/tsuyoshiyamada/ai-workbench/work/abil-ws-sauna/` — サウナブランド（図解・キャンペーン等）
- `/Users/tsuyoshiyamada/ai-workbench/work/abil-ws-pickleball/` — ピックル等
